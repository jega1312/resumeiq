    ...
    <>
      <section className="bg-linear-to-r from-[#03001C] to-[#1b1042] py-36 flex flex-col gap-14">
        ...
        <div className="flex flex-col justify-center items-center gap-5">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-inter text-white font-bold">
            How It Works
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 w-[80%] 2xl:w-[70%] mx-auto gap-10">
          {processes.map((process) => (
            <div
              key={process.id}
              className="relative flex flex-col gap-5 p-10 bg-slate-950 mx-auto rounded-3xl border border-purple-500 hover:border-white w-full hover:bg-purple-950/20 hover transition duration-300 ease-in-out group"
            >
              {/* Numbering */}
              ...
              <div className="flex flex-col gap-2">
                <h1 className="text-2xl font-inter text-white font-bold">
                  {process.heading}
                </h1>

...
function Navbar() {
  ...
  return (
    <nav className="flex justify-between flex-wrap items-center py-6 px-8 lg:px-10 bg-linear-to-b from-[#03001C] to-[#1b1042] ">
      {/* Logo Container */}
      <div className="flex gap-2 items-center">
        ...
        />
        <h1 className="text-base md:text-xl font-bold font-inter text-white">ResumeIQ</h1>
      </div>
      ...
      >
        <ul className="flex flex-col items-start justify-center gap-10 list-none">
          <li>
            <a
              href="#process"
              className="no-underline font-inter font-medium text-4xl relative group text-white"
            >
              Process
        ...
        <button
          type="button"
          className="py-3 px-5 bg-purple-500 font-inter font-medium text-white text-xl rounded-sm hover:bg-linear-to-r hover:from-purple-500 hover:to-blue-600 transition duration-300 ease-in-out relative hover:scale-110 hover:cursor-pointer"
        >
          Get Started
        </button>
      </div>
      ...
      <ul className="hidden lg:flex items-center gap-4 list-none">
        <li>
          <a
            href="#process"
            className="no-underline font-inter font-medium text-lg relative group text-white"
          >
            Process
            <span className="h-0.5 bg-linear-to-r from-purple-500 to-blue-600 rounded-full block scale-x-0 origin-center group-hover:scale-x-100 transition duration-300 ease-in-out"></span>
          </a>
      ...
      <button
        type="button"
        className="hidden lg:block py-2 px-4 bg-purple-500 font-inter font-medium text-white rounded-sm hover:bg-linear-to-r hover:from-purple-500 hover:to-blue-600 transition duration-300 ease-in-out relative hover:scale-110 hover:cursor-pointer"
      >
        Get Started
      </button>
    </nav>

    ...
    >
      ...
      <div className="flex flex-col justify-center items-center gap-5">
        <motion.h2
          ...
          className="text-3xl md:text-4xl lg:text-5xl font-inter text-white font-bold text-center text-balance w-[90%] md:w-full mx-auto"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:justify-center place-items-center w-full md:w-[90%] max-w-6xl mx-auto gap-10 overflow-hidden">
        ...
        <div className="flex flex-col items-start gap-10">
          <motion.h3
            ...
            transition={{ duration: 0.8, ease: "easeOut", delay: 0.1 }}
            className="text-3xl md:text-4xl font-inter text-white font-bold text-center text-balance w-[90%] md:w-full mx-auto"
          >
            What You'll Get
          </motion.h3>
